  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.placeholderTitle}>Review & best-take selection</Text>
        <Text style={styles.placeholderBody}>Coming in Phase 4</Text>
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Text style={styles.primaryButtonText}>Continue to Export →</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
